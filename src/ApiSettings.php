...
{
    const NAMESPACE = 'ApiClients\\Client\\Dependabot\\Resource';
    const TRANSPORT_OPTIONS = [
        ...
        FoundationOptions::TRANSPORT_OPTIONS => [
            TransportOptions::HOST => 'api.dependabot.com',
            ...
            TransportOptions::DEFAULT_REQUEST_OPTIONS => [
                UserAgentMiddleware::class => [
                    ...
                    UserAgentMiddlewareOptions::PACKAGE => 'api-clients/dependabot',
                ],
            ],
        ],
    ];
